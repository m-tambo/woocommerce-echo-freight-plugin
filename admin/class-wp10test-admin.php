...
class Wp10Test_Admin
{
	...
	public function my_admin_menu()
	{
		...
		add_menu_page('Echo General Settings', 'Echo Settings', 'manage_options', 'wp10test/wp10settingsgeneral.php', array($this, 'echosettingscallback'), 'dashicons-heart', 250);

		add_submenu_page('wp10test/wp10settingsgeneral.php', 'Sub 1', 'Echo Importer', 'manage_options', 'wp10test/wp10importer.php', array($this, 'echoimportercall'));
	}

	public function echosettingscallback()
	{
		//return views
		require_once 'partials/echosettingscallback.php';
	}

	public function echoimportercall()
	{
		//return views
		require_once 'partials/echoimportercall.php';
	}
	...
	public function register_wp10_general_settings()
	{
		...
		register_setting('echocustomsettings', 'youtubeAPIKey');
		register_setting('echocustomsettings', 'youtubeChannelID');
	}

	public function register_wp10_shortcode_settings()
	{
		//register the shortcode settings
		register_setting('echoshortcodesettings', 'ypostcount');
		register_setting('echoshortcodesettings', 'yvidstyletype');
	}

	public function register_wp10_advertiser_settings()
	{
		//register the advertiser settings
		register_setting('echoadsettings', 'advideo');
		register_setting('echoadsettings', 'adtitle');
		register_setting('echoadsettings', 'adbodycopy');
		register_setting('echoadsettings', 'adbuttoncopy');
		register_setting('echoadsettings', 'adskipseconds');
	}
