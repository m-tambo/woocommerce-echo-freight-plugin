 ...
 * @since      1.0.0
 *
 * @package    partials/echosettingscallback
 */
?>
  ...
  <div class="row">
    <div class="col">
      <div class="alert alert-warning">
        ...
        <form method="post" action="options.php">
          <?php
          settings_fields('echocustomsettings');
          do_settings_sections('echocustomsettings')
          ?>
    ...
    <div class="col">
      <div class="alert alert-success">
        ...
        <form method="post" action="options.php">
          <?php
          settings_fields('echoshortcodesettings');
          do_settings_sections('echoshortcodesettings')
          ?>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <select class="form-control" id="yvidstyletype" name="yvidstyletype">
              <option <?php if (get_option('yvidstyletype') == 'Image Left') {
                        echo (' selected');
                      } ?>>Image Left</option>
              <option <?php if (get_option('yvidstyletype') == 'Image Center') {
                        echo (' selected');
                      } ?>>Image Center</option>
              <option <?php if (get_option('yvidstyletype') == 'Image Right') {
                        echo (' selected');
                      } ?>>Image Right</option>
            </select>
          </div>
